...
public class ManageCustomersFormController {
    ...
    public TextField txtCustomerName;//tightly coupling
    public TextField txtCustomerId;//tightly coupling
    public JFXButton btnDelete;//tightly coupling
    public JFXButton btnSave;//tightly coupling
    public TextField txtCustomerAddress;//tightly coupling
    public TableView<CustomerTM> tblCustomers;//tightly coupling
    public JFXButton btnAddNewCustomer;//tightly coupling
...
//            }
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
           ...
           /* Connection connection = DBConnection.getDbConnection().getConnection();
            ...
            customerDAO1.deleteCustomer(id);
    ...
    private String generateNewId() {
        try {
            String currentID = customerDAO.genarateNewID();
            if (currentID != null) {
